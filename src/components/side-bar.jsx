...
const SideBar = () => {
    // Load initial state from localStorage or use a default value
    ...
    return ( 
      ...
      <>
        <div
                className={` ${
                    open ? "translate-x-0 w-40" : "translate-x-0 w-0 "
                } bg-gray-800  shadow duration-300 h-screen`}
            >
                                ...
                                >
                                    ...
                                    >
                                        <path
                                            strokeLinecap="round"
                                            strokeLinejoin="round"
                                            d="M20 13V6a2 2 0 00-2-2H6a2 2 0 00-2 2v7m16 0v5a2 2 0 01-2 2H6a2 2 0 01-2-2v-5m16 0h-2.586a1 1
            ...
            <div
            className={` ${
                    open ? "translate-x-0 w-10" : "translate-x-0  w-16"
                }  flex-col h-screen px-4 py-2 bg-gray-800 shadow duration-300`}>
                  ...
                  <button onClick={() => setIsOpen(!open)}>
                        ...
                        <div className="mt-12">{!open ? <div>
                            <svg
                                        xmlns="http://www.w3.org/2000/svg"
                                        className="w-6 h-6 text-gray-100 hover:bg-white/20"
                                        fill="none"
                                        viewBox="0 0 24 24"
                                        stroke="currentColor"
                                        strokeWidth={2}
                                    ...
                                    <svg 
                                        xmlns="http://www.w3.org/2000/svg"
                                        className="w-6 h-6 text-gray-100 mt-3 hover:bg-white/20"
                                        fill="none"
                                        viewBox="0 0 24 24"
                                        stroke="currentColor"
                                        strokeWidth={2}
